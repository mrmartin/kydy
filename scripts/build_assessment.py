...
SITE = ROOT / 'site'
ELECTION = 'Komunální volby 2026 – zastupitelstvo města Brna'
STATUSES = {
    ...
    'bez_opory': {'label': 'Jen kydy!', 'short': 'Jen kydy!', 'css': 'unknown'},
}
...
def page(title, body, path, description='Sliby brněnských kampaní, osobní hlasy a ověřitelné důvody hodnocení.'):
    full_title = f'{title} · {ELECTION}' if path else ELECTION
    footer = '''<footer class="footer"><a class="wordmark" href="/">kydy<span>.cz</span></a><p class="election-footer"><strong>Komunální volby 2026 – zastupitelstvo města Brna</strong></p><p>Celoměstská úroveň · Brno, Jihomoravský kraj.</p><p>Podklady pro vlastní rozhodnutí.</p><nav aria-label="Patička"><a href="/metodika.html">Jak hodnotíme</a><a href="/mapa-webu.html">Mapa webu a celý archiv</a><a href="/data/hodnoceni-kampani.json">Data JSON</a><a href="/data/hodnoceni-slibu.csv">Data CSV</a><a href="https://github.com/mrmartin/kydy/issues">Nahlásit chybu se zdrojem</a></nav><p class="fine">Veřejné podklady zpracované s pomocí AI. Posouzení neprošlo nezávislou externí recenzí. Budoucí chování nelze zaručit.</p></footer>'''
    return f'''<!doctype html>
<html lang="cs"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{escape(full_title)} · kydy.cz</title><meta name="description" content="{escape(description)}"><meta name="theme-color" content="#f7f5ef"><link rel="canonical" href="https://kydy.cz/{escape(path)}"><meta property="og:title" content="{escape(full_title)}"><meta property="og:description" content="{escape(description)}"><meta property="og:type" content="website"><meta property="og:locale" content="cs_CZ"><link rel="stylesheet" href="/assets/kydy.css"><link rel="icon" href="/assets/favicon.svg" type="image/svg+xml"></head><body><a class="skip" href="#obsah">Přejít na obsah</a><header class="masthead"><a class="wordmark" href="/" aria-label="Kydy.cz – všechny kampaně">kydy<span>.cz</span></a><div class="edition"><strong>Komunální volby 2026</strong><span>Zastupitelstvo města Brna</span></div></header><main id="obsah">{body}</main>{footer}</body></html>'''
...
def build():
    ...
    for name, files in groups:
        ...
        for f in files:
            ...
            label=html.unescape(title[1]).removesuffix(' · kydy.cz').removesuffix(' · '+ELECTION) if title else f.stem
